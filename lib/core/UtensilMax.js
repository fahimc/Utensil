...
function toolkitDragMouseMove(event) {
	...
	if(draggableObject.style.position && draggableObject.style.position=="absolute")
	{
		draggableObject.style.left = left + "px";
		draggableObject.style.top = top + "px";
	}else{
		draggableObject.style.marginLeft = left + "px";
		draggableObject.style.marginTop = top + "px";
	}
...
function toolkitDragMouseDown(event) {
	if(draggableObject.style.position && draggableObject.style.position=="absolute")
	{
		...
		startX= draggableObject.style.marginLeft.replace("px","");
		startY= draggableObject.style.marginTop.replace("px","");
	}
	preventDefault(event);
	if(Browser.isIE) {
